...
@section('content')
	...
	<div class="row">
		<div class="col-lg-12 margin-tb">
			<center><h2 class="font-weight-bold">Add New booking</h2></center>
		</div>
	</div>
				...
				<form action="{{ route('bookings.store')}}" method="POST">
					...
					<div class="col-xs-6 col-sm-6 col-md-6">
						<div class="form-group  {{ $errors->has('guest_no') ? 'has-error' : '' }}">
							...
							<input type="number" min="1" max="100" name="guest_no" id="guest_no" class="form-control" placeholder="Guest Number" value="{{ old('guest_no') }}" min='1' oninput="validity.valid||(value='');">
						</div>
					</div>
					...
					<div class="col-xs-6 col-sm-6 col-md-6">
						<div class="form-group  {{ $errors->has('totalprice') ? 'has-error' : '' }}">
							...
							<input type="number" name="totalprice" id="totalprice" class="form-control" placeholder="Total Price" value="{{ old('totalprice') }}">
						</div>
					</div>
					...
					<div class="col-xs-6 col-sm-6 col-md-6">
						<div class="form-group  {{ $errors->has('booking_remark') ? 'has-error' : '' }}">
							...
							<textarea name="booking_remark" class="form-control" placeholder="Booking_remark">{{ old('booking_remark') }}</textarea>
						</div>
					</div>
